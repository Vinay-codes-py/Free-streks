...
GLOBAL_CSS = "<style>@import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap'); html, body, [class*='css'] { font-family: 'Inter', sans-serif; background-color: #FFFC00; color: #000000; } div[data-testid='stBlock'] { background: #FFFC00 !important; border: none !important; box-shadow: none !important; padding: 20px !important; margin-bottom: 25px; } .premium-header { text-align: center; margin-bottom: 25px; } .title-main { font-size: 30px; font-weight: 800; color: #000000; letter-spacing: -0.5px; } .title-sub { font-size: 15px; color: #000000; font-weight: 500; } .input-label { font-weight: 600 !important; color: #000000 !important; font-size: 14px !important; margin-bottom: 8px !important; display: block; } div[data-baseweb='input'] { background-color: #fcf6e2 !important; border: 1px solid #ffde00 !important; border-radius: 10px !important; } div[data-baseweb='input'] input { color: #000000 !important; font-weight: 600 !important; font-size: 16px !important; } .stButton > button { background-color: #fffc00 !important; color: #000000 !important; border-radius: 10px !important; width: 100% !important; font-weight: 700 !important; border: none !important; box-shadow: 0 2px 5px rgba(255, 252, 0, 0.4) !important; text-transform: uppercase; font-size: 14px !important; letter-spacing: 0.5px; } .centered-logo { display: block; margin-left: auto; margin-right: auto; width: 90px; margin-bottom: 15px; border-radius: 20px; }</style>"
...
# ==========================================
    ...
    st.markdown("<div class='premium-header'><div class='title-main' style='color:#000000;'>🔒 Secure Token Isolated</div></div>", unsafe_allow_html=True)
    
    token_card = f"<div style='text-align:center; padding:20px; background:#ffffff; border-radius:12px; border:1px solid #ffde00; margin-bottom:20px; box-shadow: 0 4px 14px rgba(0,0,0,0.03);'><h3>Generated Session Key: <span style='color:#ef4444; font-family:monospace;'>{str(st.session_state.token)}</span></h3><p style='color:#475569; font-size:14px;'>Standard Distribution Waiting Queue Frame: <b>24 Hours</b>.</p></div>"
    st.markdown(token_card, unsafe_allow_html=True)
    
    st.markdown("<div style='text-align:center; margin-bottom: 25px;'><h4 style='color:#000000; font-weight:700; margin-bottom:4px;'>⚡ Instant Priority Pipeline Delivery (1 Hour)</h4><p style='color:#000000; font-size:13px;'>Bypass the global 24-hour server lock queue by verifying your official Vinay Chat session footprint identity.</p></div>", unsafe_allow_html=True)
...
# ==========================================
    ...
    st.markdown("<div class='premium-header'><div class='title-main' style='color:#000000;'>✅ Footprint Verification Successful</div></div>", unsafe_allow_html=True)
    
    final_success = "<div style='text-align:center; padding:35px 20px; background:#ffffff; border-radius:12px; border:1px solid #ffde00; box-shadow: 0 4px 14px rgba(0,0,0,0.03);'><h2 style='color:#16a34a; font-weight:800; margin-bottom:10px;'>Queue Bypassed!</h2><p style='color:#1e293b; font-size:16px; font-weight:500;'>Your official Vinay Chat token validation is approved.</p><p style='color:#2563eb; font-weight:700; font-size:15px; margin-top:15px;'>🚀 Allocation Injection Status: Active (Est. Arrival: 45 - 60 Mins)</p></div>"
